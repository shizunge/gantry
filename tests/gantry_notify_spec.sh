...
Describe 'notify'
  ...
  Describe "test_notify_apprise"
    ...
    It 'run_test'
      ...
      The stdout should satisfy spec_expect_no_message "Snippet.*${NUM_SERVICES_ERRORS}"
  ...
  Describe "test_notify_on_change_errors"
    ...
    It 'run_test'
      ...
      The status should be failure
      The stdout should satisfy display_output
      The stdout should satisfy spec_expect_message    "Subject.*0 service\(s\) updated, 1 update failed, 1 error\(s\) TEST_\\\\\"\\\\TITLE"
      ...
      The stdout should satisfy spec_expect_message    "Snippet.*${NUM_SERVICES_ERRORS}"
      The stdout should satisfy spec_expect_message    "${TOTAL_EMAIL_COUNT_IS_ONE}"
      The stderr should satisfy display_output
      The stderr should satisfy spec_expect_no_message "${START_WITHOUT_A_SQUARE_BRACKET}"
      The stderr should satisfy spec_expect_no_message "${SKIP_UPDATING}.*${SERVICE_NAME}"
